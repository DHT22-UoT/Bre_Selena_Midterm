...
# Ashley: Overall, report is well organized - the code chunks are easy to follow and section headers make the report well organized and easy to follow as well. One suggestion is to try to avoid hard-coding values, it is best to try to calculate values within the code in case anything changes to the code.
```